function [geom_bndry_panels] =mingyu_pre_correct_pnl_orients(num_cond,num_diel,geom_bndry_panels,Eps_inout,Cnt,dx,fl_plot_pnl_orients)
% for ii=1:num_cond
