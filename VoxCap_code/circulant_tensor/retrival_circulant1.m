...
if size_stored_tensor(1) > 3 %the prestored tensor is compressed
    ...
    temp_tens=Toeplitz_JVIE('G_xx_charge',L+1,M+1,N+1,dx^3*G_mn_xx_c(1:L+1,1:M,1:N)); % Gp_mn_xx
    fN_ch_all{1,1,1} = zeros(2*L+6,2*M+6,2*N+4);
    fN_ch_all{1,1,1}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
    fN_ch_all{1,1,1}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
    fN_ch_all{1,1,1}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
    fN_ch_all{1,1,1}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
    fN_ch_all{1,1,1}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
    fN_ch_all{1,1,1}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
    fN_ch_all{1,1,1}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
    fN_ch_all{1,1,1}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
    clear temp_tens
%     [fN_ch_all{1,1,1}] = Toeplitz_JVIE('G_xx_charge',L+1,M+1,N+1,dx^3*G_mn_xx_c(1:L+1,1:M,1:N)); % Gp_mn_xx
    ...
    if (fl_diel == 1)
        ...
        temp_tens=Toeplitz_JVIE('G_xx_Efield',L+1,M+1,N+1,dx^2*G_mn_xx_e(1:L+1,1:M,1:N)); % Gp_mn_xx
        fN_ch_all{1,1,2} = zeros(2*L+6,2*M+6,2*N+4);
        fN_ch_all{1,1,2}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
        fN_ch_all{1,1,2}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
        fN_ch_all{1,1,2}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{1,1,2}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{1,1,2}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{1,1,2}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{1,1,2}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
        fN_ch_all{1,1,2}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
        clear temp_tens
...
%     [fN_ch_all{2,2,1}] = Toeplitz_JVIE('G_yy_charge',L+1,M+1,N+1,dx^3*G_mn_yy_c(1:L,1:M+1,1:N)); % Gp_mn_yy
    temp_tens=Toeplitz_JVIE('G_yy_charge',L+1,M+1,N+1,dx^3*G_mn_yy_c(1:L,1:M+1,1:N)); % Gp_mn_yy
    fN_ch_all{2,2,1} = zeros(2*L+6,2*M+6,2*N+4);
    fN_ch_all{2,2,1}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
    fN_ch_all{2,2,1}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
    fN_ch_all{2,2,1}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
    fN_ch_all{2,2,1}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
    fN_ch_all{2,2,1}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
    fN_ch_all{2,2,1}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
    fN_ch_all{2,2,1}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
    fN_ch_all{2,2,1}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
    clear temp_tens
    clear G_mn_yy_c
    if (fl_no_fft == 0)
        tic
...
%         [fN_ch_all{2,2,2}] = Toeplitz_JVIE('G_yy_Efield',L+1,M+1,N+1,dx^2*G_mn_yy_e(1:L,1:M+1,1:N)); % Gp_mn_yy
        temp_tens=Toeplitz_JVIE('G_yy_Efield',L+1,M+1,N+1,dx^2*G_mn_yy_e(1:L,1:M+1,1:N)); % Gp_mn_yy
        fN_ch_all{2,2,2} = zeros(2*L+6,2*M+6,2*N+4);
        fN_ch_all{2,2,2}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
        fN_ch_all{2,2,2}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
        fN_ch_all{2,2,2}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{2,2,2}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{2,2,2}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{2,2,2}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{2,2,2}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
        fN_ch_all{2,2,2}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
        clear temp_tens
...
%     [fN_ch_all{3,3,1}] = Toeplitz_JVIE('G_zz_charge',L+1,M+1,N+1,dx^3*G_mn_zz_c(1:L,1:M,1:N+1)); % Gp_mn_zz
    temp_tens=Toeplitz_JVIE('G_zz_charge',L+1,M+1,N+1,dx^3*G_mn_zz_c(1:L,1:M,1:N+1)); % Gp_mn_zz
    fN_ch_all{3,3,1} = zeros(2*L+6,2*M+6,2*N+4);
    fN_ch_all{3,3,1}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
    fN_ch_all{3,3,1}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
    fN_ch_all{3,3,1}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
    fN_ch_all{3,3,1}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
    fN_ch_all{3,3,1}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
    fN_ch_all{3,3,1}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
    fN_ch_all{3,3,1}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
    fN_ch_all{3,3,1}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
    clear temp_tens
...
%         [fN_ch_all{3,3,2}] = Toeplitz_JVIE('G_zz_Efield',L+1,M+1,N+1,dx^2*G_mn_zz_e(1:L,1:M,1:N+1)); % Gp_mn_zz
        temp_tens=Toeplitz_JVIE('G_zz_Efield',L+1,M+1,N+1,dx^2*G_mn_zz_e(1:L,1:M,1:N+1)); % Gp_mn_zz
        fN_ch_all{3,3,2} = zeros(2*L+6,2*M+6,2*N+4);
        fN_ch_all{3,3,2}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
        fN_ch_all{3,3,2}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
        fN_ch_all{3,3,2}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{3,3,2}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{3,3,2}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{3,3,2}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{3,3,2}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
        fN_ch_all{3,3,2}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
        clear temp_tens
        clear G_mn_zz_e
        if (fl_no_fft == 0)
            tic
...
%     [fN_ch_all{1,2,1}] = Toeplitz_JVIE('G_xy_charge',L+1,M+1,N+1,dx^3*G_mn_xy_c(1:L+2,1:M+2,1:N)); % Gp_mn_xy
    temp_tens=Toeplitz_JVIE('G_xy_charge',L+1,M+1,N+1,dx^3*G_mn_xy_c(1:L+2,1:M+2,1:N)); % Gp_mn_xy
    fN_ch_all{1,2,1} = zeros(2*L+6,2*M+6,2*N+4);
    fN_ch_all{1,2,1}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
    fN_ch_all{1,2,1}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
    fN_ch_all{1,2,1}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
    fN_ch_all{1,2,1}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
    fN_ch_all{1,2,1}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
    fN_ch_all{1,2,1}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
    fN_ch_all{1,2,1}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
    fN_ch_all{1,2,1}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
    clear temp_tens
...
%         [fN_ch_all{1,2,2}] = Toeplitz_JVIE('G_xy_Efield',L+1,M+1,N+1,dx^2*G_mn_xy_e(1:L+2,1:M+2,1:N)); % Gp_mn_xy
        temp_tens=Toeplitz_JVIE('G_xy_Efield',L+1,M+1,N+1,dx^2*G_mn_xy_e(1:L+2,1:M+2,1:N)); % Gp_mn_xy
        fN_ch_all{1,2,2} = zeros(2*L+6,2*M+6,2*N+4);
        fN_ch_all{1,2,2}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
        fN_ch_all{1,2,2}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
        fN_ch_all{1,2,2}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{1,2,2}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{1,2,2}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{1,2,2}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{1,2,2}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
        fN_ch_all{1,2,2}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
        clear temp_tens
        clear G_mn_xy_e
        if (fl_no_fft == 0)
            tic
...
%     [fN_ch_all{1,3,1}] = Toeplitz_JVIE('G_xz_charge',L+1,M+1,N+1,dx^3*G_mn_xz_c(1:L+2,1:M,1:N+2)); % Gp_mn_xz
    temp_tens=Toeplitz_JVIE('G_xz_charge',L+1,M+1,N+1,dx^3*G_mn_xz_c(1:L+2,1:M,1:N+2)); % Gp_mn_xz
    fN_ch_all{1,3,1} = zeros(2*L+6,2*M+6,2*N+4);
    fN_ch_all{1,3,1}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
    fN_ch_all{1,3,1}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
    fN_ch_all{1,3,1}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
    fN_ch_all{1,3,1}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
    fN_ch_all{1,3,1}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
    fN_ch_all{1,3,1}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
    fN_ch_all{1,3,1}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
    fN_ch_all{1,3,1}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
    clear temp_tens
    clear G_mn_xz_c
    if (fl_no_fft == 0)
        tic
...
%         [fN_ch_all{1,3,2}] = Toeplitz_JVIE('G_xz_Efield',L+1,M+1,N+1,dx^2*G_mn_xz_e(1:L+2,1:M,1:N+2)); % Gp_mn_xz
        temp_tens=Toeplitz_JVIE('G_xz_Efield',L+1,M+1,N+1,dx^2*G_mn_xz_e(1:L+2,1:M,1:N+2)); % Gp_mn_xz
        fN_ch_all{1,3,2} = zeros(2*L+6,2*M+6,2*N+4);
        fN_ch_all{1,3,2}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
        fN_ch_all{1,3,2}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
        fN_ch_all{1,3,2}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{1,3,2}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{1,3,2}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{1,3,2}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{1,3,2}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
        fN_ch_all{1,3,2}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
        clear temp_tens
        clear G_mn_xz_e
        if (fl_no_fft == 0)
            tic
...
%     [fN_ch_all{2,3,1}] = Toeplitz_JVIE('G_yz_charge',L+1,M+1,N+1,dx^3*G_mn_yz_c(1:L,1:M+2,1:N+2)); % Gp_mn_yz
    temp_tens=Toeplitz_JVIE('G_yz_charge',L+1,M+1,N+1,dx^3*G_mn_yz_c(1:L,1:M+2,1:N+2)); % Gp_mn_yz
    fN_ch_all{2,3,1} = zeros(2*L+6,2*M+6,2*N+4);
    fN_ch_all{2,3,1}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
    fN_ch_all{2,3,1}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
    fN_ch_all{2,3,1}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
    fN_ch_all{2,3,1}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
    fN_ch_all{2,3,1}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
    fN_ch_all{2,3,1}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
    fN_ch_all{2,3,1}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
    fN_ch_all{2,3,1}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
    clear temp_tens
    clear G_mn_yz_c
    if (fl_no_fft == 0)
        tic
...
%         [fN_ch_all{2,3,2}] = Toeplitz_JVIE('G_yz_Efield',L+1,M+1,N+1,dx^2*G_mn_yz_e(1:L,1:M+2,1:N+2)); % Gp_mn_yz
        temp_tens=Toeplitz_JVIE('G_yz_Efield',L+1,M+1,N+1,dx^2*G_mn_yz_e(1:L,1:M+2,1:N+2)); % Gp_mn_yz
        fN_ch_all{2,3,2} = zeros(2*L+6,2*M+6,2*N+4);
        fN_ch_all{2,3,2}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
        fN_ch_all{2,3,2}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
        fN_ch_all{2,3,2}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{2,3,2}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{2,3,2}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{2,3,2}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{2,3,2}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
        fN_ch_all{2,3,2}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
        clear temp_tens
        clear G_mn_yz_e
        if (fl_no_fft == 0)
            tic
...
%         [fN_ch_all{2,1,2}] = Toeplitz_JVIE('G_yx_Efield',L+1,M+1,N+1,dx^2*G_mn_yx_e(1:L+2,1:M+2,1:N)); % Gp_mn_yx
        temp_tens=Toeplitz_JVIE('G_yx_Efield',L+1,M+1,N+1,dx^2*G_mn_yx_e(1:L+2,1:M+2,1:N)); % Gp_mn_yx
        fN_ch_all{2,1,2} = zeros(2*L+6,2*M+6,2*N+4);
        fN_ch_all{2,1,2}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
        fN_ch_all{2,1,2}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
        fN_ch_all{2,1,2}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{2,1,2}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{2,1,2}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{2,1,2}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{2,1,2}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
        fN_ch_all{2,1,2}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
        clear temp_tens
        clear G_mn_yx_e
    else                         %the prestored tensor is not compressed
...
%         [fN_ch_all{3,1,2}] = Toeplitz_JVIE('G_zx_Efield',L+1,M+1,N+1,dx^2*G_mn_zx_e(1:L+2,1:M,1:N+2)); % Gp_mn_zx
        temp_tens= Toeplitz_JVIE('G_zx_Efield',L+1,M+1,N+1,dx^2*G_mn_zx_e(1:L+2,1:M,1:N+2)); % Gp_mn_zx
        fN_ch_all{3,1,2} = zeros(2*L+6,2*M+6,2*N+4);
        fN_ch_all{3,1,2}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
        fN_ch_all{3,1,2}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
        fN_ch_all{3,1,2}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{3,1,2}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{3,1,2}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{3,1,2}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{3,1,2}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
        fN_ch_all{3,1,2}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
        clear temp_tens
        clear G_mn_zx_e
    else                         %the prestored tensor is not compressed
...
%         [fN_ch_all{3,2,2}] = Toeplitz_JVIE('G_zy_Efield',L+1,M+1,N+1,dx^2*G_mn_zy_e(1:L,1:M+2,1:N+2)); % Gp_mn_zx
        temp_tens= Toeplitz_JVIE('G_zy_Efield',L+1,M+1,N+1,dx^2*G_mn_zy_e(1:L,1:M+2,1:N+2)); % Gp_mn_zx
        fN_ch_all{3,2,2} = zeros(2*L+6,2*M+6,2*N+4);
        fN_ch_all{3,2,2}(1:L+2,1:M+2,1:N+2)=temp_tens(1:L+2,1:M+2,1:N+2);
        fN_ch_all{3,2,2}(L+7:2*L+6,1:M+2,1:N+2)=temp_tens(L+3:2*L+2,1:M+2,1:N+2);
        fN_ch_all{3,2,2}(1:L+2,M+7:2*M+6,1:N+2)=temp_tens(1:L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{3,2,2}(L+7:2*L+6,M+7:2*M+6,1:N+2)=temp_tens(L+3:2*L+2,M+3:2*M+2,1:N+2);
        fN_ch_all{3,2,2}(1:L+2,1:M+2,N+5:2*N+4)=temp_tens(1:L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{3,2,2}(L+7:2*L+6,1:M+2,N+5:2*N+4)=temp_tens(L+3:2*L+2,1:M+2,N+3:2*N+2);
        fN_ch_all{3,2,2}(1:L+2,M+7:2*M+6,N+5:2*N+4)=temp_tens(1:L+2,M+3:2*M+2,N+3:2*N+2);
        fN_ch_all{3,2,2}(L+7:2*L+6,M+7:2*M+6,N+5:2*N+4)=temp_tens(L+3:2*L+2,M+3:2*M+2,N+3:2*N+2);
        clear temp_tens
        clear G_mn_zy_e
    else                         %the prestored tensor is not compressed
