...
fl_precond=2; %set 1 to implement preconditioner
...
if (fl_save_data == 1)
    ...
    save('results_numexE_small/data_geo.mat', 'dx', 'geom_bndry_panels', 'inds_glob','Eps_inout','-v7.3');
    
    % data pertinent to solution
    save('results_numexE_small/data_solution.mat', 'q_charge_vect','V_RHS','C_mat');
