...

{
    ...
    //if (round((x_bnd[0])/dx)< 0)
    //{
        x_low=round((x_bnd[0])/dx);//0;
    //}
   // else
    //{
    //    x_low=round((x_bnd[0])/dx);
   // }
   // if (round((x_bnd[1])/dx) > L)
   // {
   //     x_up=L;
   // }
   // else
   // {
        x_up=round((x_bnd[1])/dx);
   // }       
   // if (round((y_bnd[0])/dx)<0)
   // {
    //    y_low=0;
    //}
  //  else
   // {
        y_low=round((y_bnd[0])/dx);
   // }            
   // if (round((y_bnd[1])/dx) > M)
  //  {
        y_up=M;
  //  }
  //  else
  //  {
        y_up=round((y_bnd[1])/dx);
 //   } 
 //   if (round((z_bnd[0])/dx)< 0)
 //   {
//        z_low=0;
 //   }
   // else
 //   {
        z_low=round((z_bnd[0])/dx);
  //  } 
  //  if (round((z_bnd[1])/dx) > N)
   // {
  //      z_up=N;
 //   }
 //   else
 //   {
        z_up=round((z_bnd[1])/dx);
//    } 
