function [precond,ids]=implement_preconditioner_BD(dx,num_vox_in_blk,L,M,N,geom_bndry_panels_test,Eps_inout,inds_glob,num_diel)
lili=tic;
fl_diel=0;
        ...
        for kk=1:length(ids{ii})
            if kk==ll
                ...
                if geom_bndry_panels_test(ids{ii}(kk),5)==0
                    ...
                    elseif abs(geom_bndry_panels_test(ids{ii}(kk),4))==2 && abs(geom_bndry_panels_test(ids{ii}(ll),4))==1
                        ...
                        precond_test{ii}(kk,ll)=fN_charge{2,1,1}(index(1),index(2),index(3));
                    ...
                    elseif abs(geom_bndry_panels_test(ids{ii}(kk),4))==3 && abs(geom_bndry_panels_test(ids{ii}(ll),4))==1
                        if geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1)>=-1e-13
                            index(1)=round((geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1))/dx+1);
                        else
                            index(1)=round((2*num+(geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1))/dx+1)+1);
                        ...
                        precond_test{ii}(kk,ll)=fN_charge{3,1,1}(index(1),index(2),index(3));
                    ...
                    elseif abs(geom_bndry_panels_test(ids{ii}(kk),4))==3 && abs(geom_bndry_panels_test(ids{ii}(ll),4))==2
                        if geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1)>=-1e-13
                            index(1)=round((geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1))/dx+1);
                        else
                            index(1)=round((2*(num-1)+(geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1))/dx+1)+1);
                        ...
                        precond_test{ii}(kk,ll)=fN_charge{3,2,1}(index(1),index(2),index(3));
                    end
                elseif geom_bndry_panels_test(ids{ii}(kk),5)==1
                    if abs(geom_bndry_panels_test(ids{ii}(kk),4))==1 && abs(geom_bndry_panels_test(ids{ii}(ll),4))==1
                        if geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1)>=-1e-13
                            index(1)=round((geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1))/dx+1);
                        else
                        ...
                        precond_test{ii}(kk,ll)=fN_charge{1,1,2}(index(1),index(2),index(3));
                    elseif abs(geom_bndry_panels_test(ids{ii}(kk),4))==2 && abs(geom_bndry_panels_test(ids{ii}(ll),4))==2
                        if geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1)>=-1e-13
                            index(1)=round((geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1))/dx+1);
                        else
                        ...
                        precond_test{ii}(kk,ll)=fN_charge{2,2,2}(index(1),index(2),index(3));
                    elseif abs(geom_bndry_panels_test(ids{ii}(kk),4))==3 && abs(geom_bndry_panels_test(ids{ii}(ll),4))==3
                        if geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1)>=-1e-13
                            index(1)=round((geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1))/dx+1);
                        else
                        ...
                        precond_test{ii}(kk,ll)=fN_charge{3,3,2}(index(1),index(2),index(3));
                    elseif abs(geom_bndry_panels_test(ids{ii}(kk),4))==1 && abs(geom_bndry_panels_test(ids{ii}(ll),4))==2
                        ...
                        precond_test{ii}(kk,ll)=fN_charge{1,2,2}(index(1),index(2),index(3));
                     elseif abs(geom_bndry_panels_test(ids{ii}(kk),4))==2 && abs(geom_bndry_panels_test(ids{ii}(ll),4))==1
                        ...
                        precond_test{ii}(kk,ll)=fN_charge{2,1,2}(index(1),index(2),index(3));
                    elseif abs(geom_bndry_panels_test(ids{ii}(kk),4))==1 && abs(geom_bndry_panels_test(ids{ii}(ll),4))==3
                        if geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1)>=-1e-13
                            index(1)=round((geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1))/dx+1);
                        else
                        ...
                        precond_test{ii}(kk,ll)=fN_charge{1,3,2}(index(1),index(2),index(3));
                    elseif abs(geom_bndry_panels_test(ids{ii}(kk),4))==3 && abs(geom_bndry_panels_test(ids{ii}(ll),4))==1
                        if geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1)>=-1e-13
                            index(1)=round((geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1))/dx+1);
                        else
                        ...
                        precond_test{ii}(kk,ll)=fN_charge{3,1,2}(index(1),index(2),index(3));
                    elseif abs(geom_bndry_panels_test(ids{ii}(kk),4))==2 && abs(geom_bndry_panels_test(ids{ii}(ll),4))==3
                        if geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1)>=-1e-13
                            index(1)=round((geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1))/dx+1);
                        else
                        ...
                        precond_test{ii}(kk,ll)=fN_charge{2,3,2}(index(1),index(2),index(3));
                    elseif abs(geom_bndry_panels_test(ids{ii}(kk),4))==3 && abs(geom_bndry_panels_test(ids{ii}(ll),4))==2
                        if geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1)>=-1e-13
                            index(1)=round((geom_bndry_panels_test(ids{ii}(kk),1)-geom_bndry_panels_test(ids{ii}(ll),1))/dx+1);
                        else
                        ...
                        precond_test{ii}(kk,ll)=fN_charge{3,2,2}(index(1),index(2),index(3));
                    end
                end
            end
        end
